...
setwd("C:\\Users\\AlmeidaGabriel(Bip)\\OneDrive - BUSINESS INTEGRATION PARTNERS SPA\\DSA\\Big_Data_Analytics_com_R_e_Microsoft_Azure_Machine_Learning\\Cap11_R_Machine_Learning\\Regressao")
getwd()
